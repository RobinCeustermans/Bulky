...
namespace BulkyWeb.DataAcces.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser> //Identity has to be used, and then write code from line 18
    {
